...
module.exports = async function fetchGuildLeaderboard(timeframe) {
    return new Promise((resolve, reject) => {
        if (!timeframe) return reject(new TypeError("Invalid timeframe"));
        let endpoint = `https://api.wynncraft.com/public_api.php?action=statsLeaderboard&type=guild&timeframe=${timeframe}`;
